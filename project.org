...
- [-] BlogDetail [0%]
  - [ ] Sería bueno reducir la calidad de algunas de las imágenes, pues son muy pesadas y provocan que el sitio tarde en cargar, o en su defecto, hacer que se cargue una  versión reducida en el Blog y en BlogDetail, pero en este último, al dar click en la imágen, verla en tamaño completo a modo de galería. Hacer lazy loading
  - [ ] Mejorar los meta-datos del sitio
    - [ ] Corrección al formato de fechas
    - [ ] Tiempo de lectura
    - [ ] Añadir imágenes de portada a los post que no tienen.
