...
*** DONE Contenedor
*** IN-PROGRESS Código
**** IN-PROGRESS [#B] CourseDetail y CourseDetail [66%]
...
- [ ] El botón ver curso debe ser personalizable en contenido y enlace.
- [ ] Añadir un botón extra para algún enlace de interés en los detalles del curso.
