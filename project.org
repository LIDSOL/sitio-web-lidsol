* TODO Organización del desarrollo
...
***** DONE Hero [100%]
Se cambió el color de fondo, paso de un degradado al background general del sitio. Se cambió el texto h1 por el logo del laboratorio.
Ahora al pulsar los botones de navegación, el contador de auto-avance se reinicia. Se colocó una función y esta se invoca al dar clic en el botón 'Únete a la comunidad', para mandar un correo al laboratorio.
...
- [ ] Cuando es en pantallas pequeñas:
  - [ ] ¿Menú de hamburguesa a la izquieda o derecha?
  - [ ] El menú debe aparecer a la izquierda y con animación (estilo nautilus)
  - [ ] Colocar un ícono a cada sección (tal vez sea bueno que solo sea visible en esta vista de pantallas pequeñas)
**** TODO Footer [0%]
DEADLINE: <2026-03-13 Fri>
- [ ] Mejorar la distribución de los elementos (principalmente en pantalla grande)
- [ ] Hacer que al dar click se abra en una pestaña nueva y no en la actual
- [ ] Debe ser compatible con el selector de idioma
- [ ] Hacer una página de licencias...
...
**** TODO CourseDetail y CourseDetail [25%]
