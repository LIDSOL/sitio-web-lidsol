...
**** DONE Blog (Blog.tsx y BlogDetail.tsx) [100%]
DEADLINE: <2026-03-13 Fri>
- [X] Blog [100%]
...
**** TODO [#A] Mejorar el SEO del sitio (para posicionarlo mejor al buscar en el navegador)
...
**** NEXT [#C] Sería bueno "Normalizar" el tamaño de los títulos del Home.
**** NEXT [#C] Tal vez sería bueno cambiar el texto de "Proyectos en desarrollo" del Home, pues hay algunas investigaciones que ya no están en curso.
**** DONE [#C] Añadir una "pantalla de carga" al inicio.
**** NEXT [#A] Reorganizar los directorios para que sean como los de Hugo
**** NEXT [#B] Hacer que los íconos sean tomados de un svg local
en blog.tsx hay import { User, ArrowRight, Calendar, Clock } from "lucide-react", etc
***** IN-PROGRESS Crear un directorio en ./public/ con todos los iconos usados en el sitio Web
***** Importarlos en cada página
***** Borrar el directorio ./src/components/ui/iconos y verificar que no existan errores
