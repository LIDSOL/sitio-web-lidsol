...
- [ ] Hacer que el botón Read More esté a la misma altura. Si el título es muy largo o hay más o menos tags, se ve más arriba o abajo, no se ve uniforme
- [ ] Separar más el autor, de la fecha del tiempo de lectura.
- [ ] Reducir el espacio entre la imágen y el título del post.
- [ ] Cuando se ve en pantalla pequeña, sería mejor que la descripción o los tags se oculten.
- [ ] Cambiar el bg de los tags a secondary
- [ ] Mover el Titulo de la página a la izquierda.
- [ ] El botón de Cargar más artículos no tiene función, hay que eliminarlo o darle uso.
***** NEXT BlogDetail [16%]
- [X] Corregir el formato de las fechas
- [ ] Mejorar el aspecto de las tablas de markdown.
...
- Notas:
  - Me doy cuanta que el los separadores de markdown no son correctamente soportados (---)
***** NEXT Contenido
