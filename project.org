...
- [X] Mudar el contenido al sitio actual [100%]
  - [X] Seminario de lisp
  - [X] Fundamentos de Python
  - [X] PumaHat
  - [X] Curso básico de sysadmin GNU/Linux
  - [X] Curso de LaTeX
- [X] Optimizar las imágenes
- [X] Darle funcionalidad al botón "proponer curso" con onClick con un enalce a github.
- [X] Imagen del instructor en la información del curso
- [X] El botón ver curso debe ser personalizable en contenido y enlace.
- [X] Añadir un botón extra para algún enlace de interés en los detalles del curso.
...
- [X] Sería bueno que los tags también soporten el multiidioma
- [X] El tag que muestra el nivel de dificultad del curso varía de apariencia según el idioma seleccionado.
- [X] Cambiar el texto "Inscribirse" por "Ver detalles" como en las tarjetas del grid.
- [X] Cambiar el "enrolled" a "cupo"
- [ ] ¿Una subsección para contenido de cursos?
- [X] Mejorar el aspecto de la sección de "módulos del curso".
- [X] Mejorar el aspecto de la fuente de "Descripción del curso"
**** TODO [#B] About y AboutMembers
...
- [ ] Añadir el perfil de ramenroot
- [ ] Actualizar la información de los miembros
- [ ] Mejorar las fotos de los miembros
**** DONE [#B] Home
DEADLINE: <2026-06-05 Fri>
***** DONE LatestHighlights
- [X] Mostar el último evento o el próximo evento.
- [X] Cambiar el badge/tag de los cursos lugar para que coincida con el tag del post del blog
- [X] Colocar la info del evento a modo de dots y no como un "string" solo
- [X] Cambiar de lugar el badge de "proximamente" de la tarjeta de evento y colocarlo junto a los tags
***** DONE Hero
...
- [X] Modificar el botón "únete a la comunidad", en este momento manda un mail, sería mejor usar un form de nextcloud
- [X] Optimizar el código de Hero, aún hay glow que ya no se usa.
- [X] Optimizar el carrusel
****** Glow.. descartado
...
**** NEXT [#A] Blog (Blog.tsx y BlogDetail.tsx) [75%]
DEADLINE: <2026-07-04 Sat>
- [-] Blog [75%]
  - [ ] Mejorar la imagen de portada del blog, y ajustar los post a este cambio.
  - [ ] Bloques de código adaptativos según el tema
...
- [X] Optimizar las imágenes
- [X] Hacer un script de python/js para automatizar el añadir un post nuevo
***** Notas
...
- [X] Calendario:
  ...
  - [X] Hacer que la notificación tenga el mismo ancho que el calendario.
...
- [X] Mejorar la sección de cronograma
  ...
  - [X] Añadir la información faltante de FLISOL 2026
    - [X] Añadir los ponentes faltantes
...
- [X] Optimizar las imágenes
- [X] Tener un tema adaptativo claro/oscuro para la cita.
*** TODO Optimización/Bugs/Testing/Corrección de vulnerabilidades
DEADLINE: <2026-06-12 Fri>
**** DONE [#A] Logo de LIDSoL en la pestaña del navegador
DEADLINE: <2026-07-04 Sat>
**** NEXT [#A] Ajustar el sitio web
DEADLINE: <2026-07-04 Sat>
Proporción?
**** IN-PROGRESS [#A] Correción de vulnerabilidades (dependabot)
DEADLINE: <2026-07-04 Sat>
**** TODO [#A] Actualizar README
DEADLINE: <2026-07-04 Sat>
**** TODO [#A] PageSpeed / Lighthouse audit
DEADLINE: <2026-07-04 Sat>
Ejecutar auditoría de Lighthouse para identificar cuellos de botella de rendimiento, accesibilidad, y buenas prácticas. Optimizar según resultados.
**** NEXT [#B] Service Worker para PWA/offline
DEADLINE: <2026-07-08 Wed>
Implementar un Service Worker que permita:
- Cachear assets estáticos para carga offline/instantánea
- Estrategia de caché para imágenes y datos
- Instalación como PWA (manifest.json, iconos)
- Notificaciones push (opcional)
Esto mejora la experiencia de usuario en conexiones lentas y permite que el sitio funcione sin conexión.
**** TODO [#B] Mejorar el SEO del sitio (para posicionarlo mejor al buscar en el navegador)
DEADLINE: <2026-07-08 Wed>
  - Agregar meta tag de verificación de Google Search Console en index.html
  - Revisar la indexación desde Google Search Console y solicitar re-crawleo
**** TODO [#B] Colocar la información correcta en la fecha de inicio de los miembros.
DEADLINE: <2026-07-08 Wed>
**** TODO [#C] Sería bueno "Normalizar" el tamaño de los títulos del Home.
DEADLINE: <2026-07-11 Sat>
**** TODO [#C] Tal vez sería bueno cambiar el texto de "Proyectos en desarrollo" del Home, pues hay algunas investigaciones que ya no están en curso.
DEADLINE: <2026-07-11 Sat>
**** TODO [#C] Implementar un script para "convertir" md a ts, para hacer más fácil añadir contenido al sitio web
O igual añadir un panel desde el cuál, miembros del lab puedan loggearse y añadir contenido...
**** TODO [#C] Server-Side Rendering (SSR)
Migrar a un framework con SSR (Next.js, Astro, etc.) para obtener URLs reales sin hash, mejor indexación en buscadores, y mejor rendimiento de carga inicial.
**** DONE Modo oscuro automático según el sistema
**** DONE [#A] Dejar de usar npm por seguridad
El gestor de paquetes npm no es seguro por defecto y este último mes ha habido ataques a la cadena de suministros; según lo informado por SafeDep, un mantenedor comprometido publico 637 versiones maliciosas en 317 paquetes; es por ello que vamos a cambiar de gestor de paquetes a pnpm versión 11 o superior; pnpm por defecto resulta más seguro, por ejemplo, gracias a minimumReleaseAge no se instalan paquetes con menos de un día de haber sido publicados y evita la instalación de sub-dependencias de fuentes que pueden resultar "extrañas" gracias a blockExocticSubdeps.
**** DONE Desactivar la ejecución automática de scripts y crear un por área (miembros, eventos, etc) para añadir info maś fácilmente sin la necesidad de meterte al ts
**** DONE [#C] Añadir una "pantalla de carga" al inicio.
**** DONE [#A] Reorganizar los directorios para que sean como los de Hugo
**** DONE [#B] Hacer que los íconos sean tomados de un svg local
**** DONE Cuando regreso a una página anterior, que no me regrese hasta el inicio, si no que se quede en el mismo sitio antes de dar click.
**** DONE [#B] Mejora el script del blog.
**** DONE CursorEffect
