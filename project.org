...
*** DONE Contenedor
*** IN-PROGRESS Código
**** IN-PROGRESS [#B] CourseDetail y CourseDetail [94%]
DEADLINE: <2026-06-05 Fri>
- [X] Mejorar el aspecto de la tarjeta Featured Course
  Antes la imagen estaba en flujo normal, el <img> imponía su tamaño en el contenedor, forzando al grid a hacer la fila más alta.
  Ahora absolute insert-0 saca la imagen del flujo, el contenedor ignora el tamaño de la imagen.
  - El grid determina la altura de la fila solo con el contenido.
  - La columna izquierda se estira para igualar esta altura.
  - La imagen llena el contenedor con object-cover y se recorta si es necesario
  En móvil, aspect-video sigue dando la relación 16:9. En desktop, el contenedor se estira al alto del contenido.
...
**** IN-PROGRESS [#A] About y AboutMembers
DEADLINE: <2026-06-05 Fri>
...
- [ ] Modificar el botón "únete a la comunidad", en este momento manda un mail, sería mejor usar un form de nextcloud
- [ ] Optimizar el código de Hero, aún hay glow que ya no se usa.
...
**** DONE Blog (Blog.tsx y BlogDetail.tsx) [50%]
DEADLINE: <2026-03-13 Fri>
- [X] Blog [100%]
...
- [ ] Hacer un script de python/js para automatizar el añadir un post nuevo
***** Notas
...
**** IN-PROGRESS [#A] Events y EventDetail [78%]
DEADLINE: <2026-06-05 Fri>
...
- [ ] Optimizar las imágenes
- [ ] Hacer un script de js/Python para añadir eventos de forma sencilla (como en hugo)
**** IN-PROGRESS [#A] Publications
DEADLINE: <2026-06-05 Fri>
...
- [ ] Optimizar las imágenes
- [ ] Tener un tema adaptativo claro/oscuro para la cita.
*** TODO Optimización/Bugs/Testing/Corrección de vulnerabilidades
DEADLINE: <2026-06-12 Fri>
**** [#A] Mejorar el SEO del sitio (para posicionarlo mejor al buscar en el navegador)
**** NEXT Actualizar README
...
**** [#A] Desactivar la ejecución automática de scripts y crear un por área (miembros, eventos, etc) para añadir info maś fácilmente sin la necesidad de meterte al ts
**** [#B] Colocar la información correcta en la fecha de inicio de los miembros.
**** [#C] Sería bueno "Normalizar" el tamaño de los títulos del Home.
**** [#C] Tal vez sería bueno cambiar el texto de "Proyectos en desarrollo" del Home, pues hay algunas investigaciones que ya no están en curso.
**** [#C] Añadir una "pantalla de carga" al inicio.
**** [#B] Hacer que los íconos sean tomados de un svg local
