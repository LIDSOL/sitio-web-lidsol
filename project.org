...
**** IN-PROGRESS Events y EventDetail [76%]
...
- [ ] El "tag" de "próximamente" está en un campo de event.ts, que indica el estado del evento. Sería mejor que esto sea automático.
- [ ] Verificar que la notificación de próximo evento y la tarjeta de eventos de src/components/LatestHighlights.tsx no tengan errores.
- [-] Calendario:
