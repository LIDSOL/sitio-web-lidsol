...
**** IN-PROGRESS Events y EventDetail [25%]
DEADLINE: <2026-03-10 Tue>
- [-] Mudar el contenido "legacy" [76%]
...
- [-] Calendario
  ...
  - [ ] En el calendario de Events.tsx se muestra un punto debajo del día del evento + un apartado de notificaciones que muestra los próximos eventos con dos meses de antelación.
  - [X] En el calendario de EventDetail.tsx muestra encerrado en un círculo el día del evento
- [ ] Mejorar la sección de cronograma
  - [ ] Tarjeta/Sección para charlas
  - [ ] Tarjtea/Sección para talleres
  - [ ] Implementar una "tarjeta" con todos los links de interés, event_url, etc
- [ ] ¿Y Si un evento tiene más de un lugar de ubicación?
- [ ] Solo vemos la fecha de inicio pero no del final
- [ ] La tarjeta que muestra los ponentes tiene un bug 🐛
- [ ] Mejor difuminado en el cover
- [ ] Mejorar el sombreado de eventsDetail
