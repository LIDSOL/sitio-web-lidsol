...
*** DONE Contenedor
*** IN-PROGRESS Código
**** IN-PROGRESS [#B] CourseDetail y CourseDetail [58%]
...
**** IN-PROGRESS [#B] Home
DEADLINE: <2026-06-05 Fri>
***** TODO LatestHighlights
- [X] Mostar el último evento o el próximo evento.
- [ ] Cambiar el badge/tag de los cursos lugar para que coincida con el tag del post del blog
- [ ] Colocar la info del evento a modo de dots y no como un "string" solo
- [ ] Cambiar de lugar el badge de "proximamente" de la tarjeta de evento y colocarlo junto a los tags
***** DONE Hero [70%]
