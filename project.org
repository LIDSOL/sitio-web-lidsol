...
- [-] Funcionalidades y aspecto
  - [-] Subpágina con detalles de las publicaciones
  ...
  - [ ] Botón de Citar/área de citar
    - [ ] Que se pueda copiar al portapapeles
    - [ ] Que puedas salir con ESC
    - [ ] Que sea un modulo independiente para usarlo dentro de Publication y PublicationDetail
