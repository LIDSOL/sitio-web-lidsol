...
**** IN-PROGRESS Blog y BlogDetail [0%]
...
- [-] Blog [22%]
  ...
  - [ ] Implementar una función sort (como en la página de proyectos).
  - [ ] Hay un botón hasta la parte inferior "Cargar más artículos" que no tiene funcionalidad. Podría ser bueno limitar la cantidad de post que se muestran y darle uso, o bien, retirarlo y que quede como un scroll con todo el contenido sin más.
...
- [ ] BlogDetail [0%]
  ...
  - [ ] Cambiar el color del botón de "volver al blog".
  - [ ] Cambiar el color de los tags a secondary.
  - [ ] Hacer que el texto tenga justificación completa.
  - [ ] Las imágenes deben tener bordes redondeados. Como la imagen de portada.
  - [ ] Mejorar el aspecto de las tablas markdown
  - [ ] Mejorar el aspecto de los bloques de código de markdown.
***** Notas
