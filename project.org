...
***** NEXT Hero [0%]
- [ ] Cambiar el texto por el logo del laboratorio.
- [ ] Cambiar el color de fondo por algo gris pero con degradados
- [ ] Mejorar el aspecto del botón "Explorar Proyectos"
- [ ] Darle función del botón "Únete a la comunidad"
